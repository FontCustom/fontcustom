...
module Fontcustom
  class CLI < Thor
    ...
    class_option :templates, :aliases => "-t", :type => :array, :desc => "List of templates to compile alongside fonts. Accepts "css", "scss", "preview" or arbitrary paths (relative to INPUT or PWD). Default: "css preview""
    ...
    class_option :css_prefix, :aliases => "-p", :desc => "The prefix for your icon CSS selectors. Default: ".icon-""
