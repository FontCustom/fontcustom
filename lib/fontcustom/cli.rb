...
module Fontcustom
  class CLI < Thor
    # Defaults are stored in Fontcustom::DEFAULT_OPTIONS
    ...
    class_option :font_name, :aliases => "--name -n", :desc => "The font name. Used in your CSS and templates. Default: 'fontcustom'"
